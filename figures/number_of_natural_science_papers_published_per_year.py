...
PROGRAM_NAME: str = "Number of Natural Science Papers Published Per Year"
DB_HELP: str = "Path to database"
FIGURE_PATH: Path = Path(
    "number_of_natural_science_papers_published_per_year.pdf"
).resolve()
...
def get_data(db: DB) -> DataFrame:
    sql_query: str = """
        ...
        JOIN searches_to_papers sbt ON sbt.search_id = s._id
