...
find $(dirname "$0")/data/$pdf_dir -name "*.pdf" -exec python automatedAnalysis.py -i {} -m "qwq" -p "Do the author's use pre-trained deep learning models in their paper?" -t 600 --prediction-tokens 2000 --context-tokens 38000 >> $output_file \;
